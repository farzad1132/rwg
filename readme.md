...
RWG is a high-performance HTTP/1.1 load generator designed for precise request scheduling and latency measurement. It runs on generator nodes, not in Kubernetes.
