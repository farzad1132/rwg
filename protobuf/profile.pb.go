...
const file_profile_proto_rawDesc = "" +
	"\n" +
	"\rprofile.proto\x12\bprotobuf\"=\n" +
	"\aRequest\x12\x1a\n" +
	"\bhotelIds\x18\x01 \x03(\tR\bhotelIds\x12\x16\n" +
	"\x06locale\x18\x02 \x01(\tR\x06locale\"1\n" +
	"\x06Result\x12'\n" +
	"\x06hotels\x18\x01 \x03(\v2\x0f.protobuf.HotelR\x06hotels\"\x17\n" +
	"\x05Hotel\x12\x0e\n" +
	...
	"\aProfile\x122\n" +
	"\vGetProfiles\x12\x11.protobuf.Request\x1a\x10.protobuf.ResultB$Z\"github.com/farzad1132/rwg/protobufb\x06proto3"
...
var file_profile_proto_goTypes = []any{
	...
	(*Hotel)(nil),   // 2: protobuf.Hotel
	(*Address)(nil), // 3: protobuf.Address
	(*Image)(nil),   // 4: protobuf.Image
}
var file_profile_proto_depIdxs = []int32{
	2, // 0: protobuf.Result.hotels:type_name -> protobuf.Hotel
	0, // 1: protobuf.Profile.GetProfiles:input_type -> protobuf.Request
	1, // 2: protobuf.Profile.GetProfiles:output_type -> protobuf.Result
